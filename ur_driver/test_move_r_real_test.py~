...
position1 = [-2.0334, -1.4875, -2.2393, -1.5613, -1.6153, -0.5325]

position11= [-2.255, -1.8062, -1.9841, -1.4782, -1.7345, -0.3445]

position12 = [-2.3932, -2.0984, -1.6442, -1.502, -1.806, -0.2239]
...
def move1():
    ...
    g.trajectory.points = [JointTrajectoryPoint(positions=position1, velocities=[0]*6, time_from_start=rospy.Duration(5.0)),JointTrajectoryPoint(positions=position11, velocities=[0]*6, time_from_start=rospy.Duration(10.0)),JointTrajectoryPoint(positions=position12, velocities=[0]*6, time_from_start=rospy.Duration(15.0)),JointTrajectoryPoint(positions=position11, velocities=[0]*6, time_from_start=rospy.Duration(20.0)),JointTrajectoryPoint(positions=position1, velocities=[0]*6,time_from_start=rospy.Duration(25.0))]
    client.send_goal(g)
    print "Sent 1"
    try:
